...
|클래스|매서드|매서드설명|
|------|---|---|
|1|DartCompInfo|고유번호 조회 매서드|완료|
|1|DartCompInfo|종목코드 조회 매서드|현재진행중|
|1|DartCompInfo|KRX기준 종목코드 보충 매서드|dart기준과 경합시 krx기준으로 대체|
|1|DartCompInfo|사업보고서 제출 여부 확인 매서드|상위 클래스 정의하여 상속하여 사용할 것|


### 임원현황 조회 클래스
|클래스|매서드|매서드설명|
|------|---|---|
|2|DartDirectorsInfo|등기임원 조회 매서드|API이용|
|2|DartDirectorsInfo|미등기임원 조회 매서드|개발진행중|
